        ...
        <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
          <div className="flex items-center gap-4">
            <span className="text-3xl font-bold tracking-tight text-white">
              EIGER<sup className="text-sm align-super opacity-60">TM</sup>
            </span>
            <span className="text-sm text-white/30">(c) 2026</span>
          </div>
          ...
          <div className="flex items-center gap-5">
            <a
              href="https://www.tiktok.com/@eiger_app?_r=1&_t=ZT-942YsOMpxef"
              target="_blank"
            ...
            <a
              href="https://www.instagram.com/eiger_app?igsh=MXhkMnU2bmVic2Q0aQ%3D%3D&utm_source=qr"
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-full bg-white/5 p-2 text-white/40 transition-all duration-300 hover:bg-white/10 hover:text-white"
            >
